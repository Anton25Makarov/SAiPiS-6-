...
function showAndHideTable() {
    ...
    if (tableShow === false) {
        ...
        let olympic_text_m = document.createTextNode("Class (№)");
...
function getIndex() {
    ...
    let valSelected = selected.options[selected.selectedIndex].text;
...
// в Id's много значений. (посмотреть)